...
## Project Structure
    ...
    ├── testapiautoteammemb_66435  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_66435`
...
2. Clone this repo and `cd testapiautoteammemb_66435`
